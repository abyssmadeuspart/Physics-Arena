use crate::case_registry::{self, AvianCaseWorld};
...
effective_thread_count,effective_worker_count,completed_step_count,physics_elapsed_ms\n";
...
pub fn write_result(
    ...
    let completed_step_count = world.completed_step_count;
    if elapsed_ms <= 0.0 ||
        ...
        completed_step_count != runner_args.step_count ||
        world.body_count != case_descriptor.body_count ||
        world.shape_count != case_descriptor.body_count ||
        world.dynamic_entities.len() != case_descriptor.dynamic_body_count
    {
        eprintln!(
            "invalid_result reason=metric elapsed_ms={:.9} step_count={} completed_step_count={} body_count={} shape_count={} dynamic_body_count={}",
            elapsed_ms,
