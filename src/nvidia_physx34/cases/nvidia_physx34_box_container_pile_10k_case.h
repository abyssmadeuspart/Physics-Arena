...
{
constexpr const char* kEngineId = "nvidia_physx34";
constexpr const char* kEngineRef = "3.4.2";
...
constexpr const char* kFixtureVersion = "nvidia_physx34_open_container_v1";
